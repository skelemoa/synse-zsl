...
unseen_zs = np.load('/ssd_scratch/cvit/pranay.gupta/language_modelling/' + wdir + '/' + le + '/cadavae_' + str(ss) + '_r_unseen_zs.npy')
seen_zs = np.load('/ssd_scratch/cvit/pranay.gupta/language_modelling/' + wdir + '/' + le + '/cadavae_' + str(ss) + '_r_seen_zs.npy')
