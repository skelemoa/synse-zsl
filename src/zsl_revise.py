...
s2v_labels = torch.from_numpy(np.load('../language_data/' + le + '_labels.npy')[:num_classes,:]).view([num_classes, att_input_size])
...
zbest = 0
if phase == 'val':
    zvisae_checkpoint = '../language_modelling/' + wdir + '/' + le + '/' + 'gvisae_best.pth.tar'
    zattae_checkpoint = '../language_modelling/' + wdir + '/' + le + '/' + 'gattae_best.pth.tar'
else:
    zvisae_checkpoint = '../language_modelling/' + wdir + '/' + le + '/' + 'main_gvisae_best.pth.tar'
    zattae_checkpoint = '../language_modelling/' + wdir + '/' + le + '/' + 'main_gattae_best.pth.tar'
early_stop = 0
print(visae)
print(attae)
